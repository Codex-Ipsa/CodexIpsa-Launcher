...
namespace MCLauncher
{
    class Globals
    {
        ...
        public static string branch = "dev-instances"; //dev
        public static string verCurrent = "0.0.7.20"; //Change this on release
        public static string verDisplay = "0.0.7.20"; //Change this on release
