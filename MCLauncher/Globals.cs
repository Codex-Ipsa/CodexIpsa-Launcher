...
namespace MCLauncher
{
    class Globals
    {
        ...
        public static string discordClient = "1120382404801069096"; //this is not here on purpose (note to self: MAKE SURE NOT TO SHIP IT IN GIT ELSE YOU'LL HAVE TO REVERT AGAIN!!!!)
