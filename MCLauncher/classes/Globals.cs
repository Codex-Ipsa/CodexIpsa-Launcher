...
namespace MCLauncher
{
    class Globals
    {
        ...
        public static string branch = "core6test"; //dev //omega13 //stable //dev-instances //experimental //pallas-testing
        public static string verCurrent = "0.3.2-1"; //Change this on release
