...
namespace MCLauncher
{
    class Globals
    {
        ...
        //Manual
        public static string codebase = "0.3.3"; //0.4.0-dev //0.3.0-prod //0.3.0-dev //0.2.1 //0.2.1-old //0.2.0 //omega13 //0.0.7-dev //mojang-data //legacyfix //legacyfix-testing
        public static string branch = "experimental"; //stable //dev //experimental //omega13 //dev-instances //pallas-testing
        public static string verCurrent = "0.3.3-pre4"; //Change this on release
        public static string verDisplay = "0.3.3-pre4"; //Change this on release
