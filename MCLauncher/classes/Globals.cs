...
namespace MCLauncher
{
    class Globals
    {
        ...
        public static string branch = "dev"; //stable //dev //experimental //omega13 //dev-instances //pallas-testing
        public static string verCurrent = "0.3.3-pre8"; //Change this on release
        public static string verDisplay = "0.3.3-pre9-wip"; //Change this on release
        ...
        public static string reuploadsManifest = $"http://codex-ipsa.dejvoss.cz/launcher/modloader/reuploads.json"; //LEGACY
        public static string fabricReuploads = $"http://api.codex-ipsa.cz/v1/modloader/fabric-reups.json";
